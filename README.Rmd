...
[![Travis build status](https://travis-ci.org/crazycapivara/rdeck.svg?branch=master)](https://travis-ci.org/crazycapivara/rdeck)
[![Project Status: Active – The project has reached a stable, usable state and is being actively developed.](https://www.repostatus.org/badges/latest/active.svg)](https://www.repostatus.org/#active)
[![CRAN status](https://www.r-pkg.org/badges/version/rdeck)](https://cran.r-project.org/package=rdeck)
